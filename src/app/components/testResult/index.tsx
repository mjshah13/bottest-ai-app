...
import { AccordionTriggerProps, Option } from "../../../utils/typesInterface";
...
const TestResult: React.FC<ModalProps> = ({
  ...
  const { fetchBaseline, baselines, isLoading: loading } = useBaseline();
  const { getTestRuns, fetchTestRuns } = useTestRun();
  ...
  return (
    <Dialog.Root open={isTestResultModal} onOpenChange={setIsTestResultModal}>
      <Dialog.Content minWidth={"1088px"} style={{ minHeight: "900px" }}>
        <Grid columns="260px 1fr" className="min-h-[900px] h-full">
          <Box>
            <div
                  ...
                  <div className=" bg-dangerLight px-6 py-3.5  rounded-lg mb-5 flex items-start   gap-3">
                    ...
                    <div className="flex flex-col ">
                      ...
                      <p className="text-black text-sm ">
                        The replayed conversation does not match the tone of any
                        of the baselines. While the tone of all of the baselines
                        is polite and friendly, the tone in the replayed
                        conversation is sarcastic and unprofessional.
                      </p>
                    </div>
                  </div>
                ) : (
                          ...
                          <div className="flex gap-4 items-end  ">
                            ...
                            <div className="w-full flex items-center gap-3">
                              <textarea
                                ...
                                className={`${
                                  "" && "text-[#909193]"
                                } mt-2.5 w-full px-2 py-2 border border-[#d0d0d0] rounded`}
                                placeholder="Enter your custom success criteria here..."
                              />
