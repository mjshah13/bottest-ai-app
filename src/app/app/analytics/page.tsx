...
const Analytics = () => {
  ...
  return (
    <div
      className={`z-0 gap-5 h-full flex flex-col ${
        !selectedSuite || !selectedEnvironment ? "mainContainer" : null
      }
      `}
    >
    ...
    rounded-lg dark:border-none dark:border dark:border-[#434447]
      ...
      >
        {!selectedSuite || !selectedEnvironment ? (
          <>
            <div className="py-7 px-4 border-2 border-[#f0f0f0]  dark:border-b dark:border-[#434447] bg-white rounded-tl-lg  rounded-tr-lg "></div>
            <div className=" w-full flex h-[84%] justify-center items-center flex-col gap-3 bg-white border-2 border-t-0 border-[#f0f0f0] rounded-bl-lg  rounded-br-lg ">
