...
const PirvacyPage = () => {
  return (
    <div className="bg-[#F7F9FB] rounded-[20px] md:pt-[160px] pt-20 pb-5 md:pb-24 px-5 md:px-12 flex flex-col items-center mb-8">
      ...
      <div>
        <p>
          Bot Test Inc. (<b>"bottest.ai,”</b> <b>“we,”</b> <b>“us,”</b> or{" "}
          <b>“our”</b>) has prepared this Privacy Policy to explain (1) what
          personal information we collect, (2) how we use and share that
          information, and (3) your choices concerning our privacy and
          information practices.
          <br /> <br />
          We provide a unified platform at bottest.ai for the management of
          chatbot applications, particularly for testing and quality assurance
          purposes (the <b>“Services”</b>). This Privacy Policy applies to
          personal information that we collect in connection with the Services,
          our website(s) (including{" "}
          <a href="https://bottest.ai/" className="underline">
            https://www.bottest.ai/
          </a>
          ), and any other products and/or services that bottest.ai provides.
          <br /> <br />
          If you are a customer of bottest.ai, this Privacy Policy does not
          apply to personal information that we process on your behalf (if any)
          as your service provider. Such personal information shall instead be
          governed by the terms and conditions of the separate customer
          agreement or terms of service that you have agreed to with bottest.ai.
        ...
        <h2 className="mt-14 mb-6 text-[#212427] text-[30px] md:text-[40px] leading-[36px] md:leading-[45px] font-medium">
          Personal information we collect
        </h2>
        <h3 className="mt-6 mb-3 text-[15px] md:text-[20px] leading-[18px] md:leading-[22px] font-medium">
          Information you provide to us
        </h3>
        <ul className="list-disc">
          <li className="my-2 ml-6">
            Account Information: When you create an account to use the Services,
            we collect information such as your email address, password, and
            other similar account registration information.
          </li>
          <li className="my-2 ml-6">
            Payment Information: If you are using a paid version of the
            Services, you may need to provide us with payment information, such
            as credit card information, banking information, or a billing
            address. We may use third-party payment providers to process
            payments on the Services. In particular, credit card information is
            stored and processed by our payment providers on our behalf.
          </li>
          <li className="my-2 ml-6">
            Business Contact Information: If you are a representative of one of
            our actual or prospective customers, suppliers or business partners,
            we may collect personal information about you (such as your name,
            contact details and role) when entering into an agreement with your
            company or otherwise during the course of our relationship with your
            company.
          </li>
          <li className="my-2 ml-6">
            Feedback or correspondence, such as information you provide when you
            contact us with questions, feedback, reviews, or otherwise
          ...
          <li className="my-2 ml-6">
            ...
            communications about our activities, services, newsletters, and
        ...
        <p>
          We may obtain your personal information from other third parties, such
          as marketing partners, publicly-available sources and data providers,
          for the purposes of marketing products and services that may interest
          you, delivering personalized communications, and other similar
          activities. In addition, we may maintain pages on social media
          platforms, such as Facebook, Twitter, Instagram, and other third-party
        ...
        <p>
          ...
          with our Services, our communications and other online services, such
          as.
        </p>
        <ul className="list-disc">
          <li className="my-2 ml-6">
          ...
          <li className="my-2 ml-6">
            ...
            or screen, access times, and duration of access, and whether you
            have opened our marketing emails or clicked links within them. We
            may use third party tools to assist with capturing online activity
            data.
          </li>
          <li className="my-2 ml-6">
            Email Open/Click Information. We may use pixels in our email
            campaigns that allow us to collect your email and IP address as well
            as the date and time you open an email or click on any links in the
            email that we may send to you.
          </li>
        </ul>
        <h3 className="mt-6 mb-3 text-[15px] md:text-[20px] leading-[18px] md:leading-[22px] font-medium">
        ...
        <p>
          ...
          special promotions, offers and events via email. You may opt out of
          our marketing communications as described in the{" "}
          <b>“Opt out of marketing communications”</b> section below.
        </p>
        <h3 className="mt-6 mb-3 text-[15px] md:text-[20px] leading-[18px] md:leading-[22px] font-medium">
        ...
        <p>
          ...
          EU laws. The legal bases depend on the Services you use and how you
        ...
        <p>
          ...
          to object to that use though, in some cases, this may mean no longer
          using the Services.
        </p>
        <h2 className="mt-14 mb-6 text-[#212427] text-[30px] md:text-[40px] leading-[36px] md:leading-[45px] font-medium">
        ...
        <p>
          ...
          Services (such as lawyers, bankers, auditors, insurers, and providers
          that assist with hosting, analytics, email delivery, marketing, and
          database management).
        </p>
        <h3 className="mt-6 mb-3 text-[15px] md:text-[20px] leading-[18px] md:leading-[22px] font-medium">
        ...
        <p>
          We may transfer or otherwise share some or all of our business or
        ...
        <p>
          We may share personal information with our current and future
        ...
        <p>
          We are headquartered in the United States. To provide and operate our
          services, it is necessary for us to process your personal information
          in the United States. If we transfer personal information across
          borders such that we are required to apply appropriate safeguards to
          personal information under applicable data protection laws, we will do
          so. Please contact us for further information about any such transfers
          or the specific safeguards applied.
        </p>
        <h2 className="mt-14 mb-6 text-[#212427] text-[30px] md:text-[40px] leading-[36px] md:leading-[45px] font-medium">
          Your choices
        </h2>
        ...
        <p>
          In certain circumstances (including based on where you are located),
          you may have the following rights in relation to your personal
          information:
        </p>
        <ul className="list-disc">
          <li className="my-2 ml-6">
        ...
        <p>
          To make a request, please contact us as provided in the{" "}
          <b>“How to Contact Us”</b> section below. We may ask for specific
          information from you to help us confirm your identity. We will require
        ...
        <p>
          ...
          time (or otherwise exercise your aforementioned rights in relation to
          your personal information) by contacting us below(see contact details
          below).
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          member state of your usual residence or place of work or of the place
          of the alleged breach, if you consider that the processing of your
          personal information carried out by bottest.ai or any of our
        ...
        <p>
          ...
          relevant authority to give written notice of whether the complaint is
          either being investigated or not being investigated and, where
          applicable, the progress and the outcome of the investigation or (B) a
          determination of the relevant authority not to investigate the
        ...
        <p>
          There are a number of ways to opt out of having your online activity
          and device data collected through our Services, for additional details
        ...
        <p>
          When you visit the careers portion of our website, we collect personal
          information that you provide to us in connection with your job
          ...
          other information of the type that may be included in a resume. This
          may also include diversity information that you voluntarily provide.
          We use this information to facilitate our recruitment activities and
          process employment applications, such as by evaluating a job candidate
          for an employment activity, and monitoring recruitment statistics. We
          may also use and share this information to provide improved
          administration of the website, and as otherwise necessary: (a) to
          comply with relevant laws or to respond to subpoenas or warrants
          served on us; (b) to protect and defend the rights or property of us
          or others; or (c) in connection with a legal investigation.
        </p>
        <h2 className="mt-14 mb-6 text-[#212427] text-[30px] md:text-[40px] leading-[36px] md:leading-[45px] font-medium">
          Data Retention
        </h2>
        ...
        <p>
          ...
          information from or about a child, please contact us via the contract
        ...
        <p>
          If you would like to submit a Data Subject Access Request or have any
          questions or concerns, you can reach us by email at{" "}
          <a href="mailto:support@bottest.ai" className="underline">
            support@bottest.ai
          </a>
          .
        </p>
        ...
        <p>
          ...
          information, you can contact us or submit a complaint to the data
        ...
        <p>
          This Cookie Policy explains how bottest.ai uses cookies and similar
          technologies in connection with our Services. This Cookie Policy
          should be read in conjunction with our Privacy Policy.
        </p>
        <br />
        <p>
          If you have any questions or concerns about the Cookie Policy, please
          contact us at{" "}
          <a href="mailto:support@bottest.ai" className="underline">
            support@bottest.ai
          </a>{" "}
        ...
        <p>
          <b>Cookies</b> are text files that websites store and access on a
          visitor’s device to uniquely identify the visitor’s browser or to
          store information or settings in the browser to allow us distinguish
          you from other users of our Services for the purpose of helping you
        ...
        <br />
        <p>
          <b>Local storage technologies</b>, like HTML5, provide
        ...
        <br />
        <p>
          <b>Web beacons</b>, also known as pixel tags or clear GIFs, are used
          to demonstrate that a webpage or email was accessed or opened, or that
          certain content was viewed or clicked.
        </p>
        <br />
        <p>
          This Cookie Policy refers to all these technologies, and other types
          of tracking technologies used through our Services, collectively as
          “cookies.”
        </p>
        <h3 className="mt-6 mb-3 text-[15px] md:text-[20px] leading-[18px] md:leading-[22px] font-medium">
        ...
        <p>
          We may use both persistent cookies and session cookies. Persistent
          cookies stay on your device for a set period of time or until you
          delete them, while session cookies are deleted once you close your web
          browser. The cookies placed through your use of our website are either
          set by us (first-party cookies) or by a third party at our request
          (third-party cookies).
        </p>
        <br />
        <p>
          We may also allow our advertising partners to collect this information
          through our website.
        </p>
        <h3 className="mt-6 mb-3 text-[15px] md:text-[20px] leading-[18px] md:leading-[22px] font-medium">
        ...
        <br />
        <p>
          <b>Strictly Necessary Cookies.</b> These cookies are necessary for the
          Services to function and cannot be switched off in our systems. They
          allow us to enable security, prevent fraud and debug the Services and
          are usually only set in response to actions made by you which amount
          to a request for services, such as setting your privacy preferences,
          logging in or filling in forms. You can set your browser to block or
          alert you about these cookies, but then some parts of the Services
          will not work.
        </p>
        <br />
        <p>
          <b>Functional Cookies.</b> These cookies are used to recognize you
          when you return to our Services or to enable the Services to provide
          enhanced functionality and personalisation. They may be set by us or
          by third party providers whose services we have added to our pages. If
          you do not allow these cookies then some or all of the Services may
          not function properly.
        </p>
        <br />
        <p>
          <b>Analytics Cookies.</b> These cookies allow us to count visits and
          traffic sources so we can measure and improve the performance of our
          Services. They help us to know which pages are the most and least
          popular and see how visitors move around the Services. All information
          these cookies collect is aggregated. If you do not allow these cookies
          we will not know when you have visited our Services and will not be
        ...
        <br />
        <p>
          <b>Blocking cookies in your browser.</b> Most browsers let you remove
          or reject cookies, including cookies used for interest-based
          advertising. To do this, follow the instructions in your browser
        ...
        <br />
        <p>
          Use the following links to learn more about how to control cookies and
          online tracking through your browser:‍{" "}
        </p>
        <a
        ...
        {" | "}
        <a
          href="https://support.google.com/chrome/answer/95647?co=GENIE.Platform=Desktop&hl=en"
          className="underline"
        >
          Chrome
        </a>
        ...
        {" | "}
        <a href="https://support.apple.com/en-gb/105082" className="underline">
          Safari (Mobile/iOS)
        </a>
        <br /> <br />
        <p>
          <b>Blocking advertising ID use in your mobile settings.</b> Your
          mobile device settings can provide functionality to limit use of the
          advertising ID associated with your mobile device for interest-based
          advertising purposes.
        </p>
        <br />
        <p>
          <b>Using privacy plug-ins or browsers.</b> You can block our websites
          from setting cookies used for interest-based ads by using a browser
          with privacy features, like{" "}
        ...
        <br />
        <p>
          <b>Platform opt-outs.</b> Some advertising companies offer opt-out
          features that let you opt out of use of your information for
          interest-based advertising, including:
        </p>
        <a
          href="https://myadcenter.google.com/personalizationoff?sasb=true"
          className="underline"
        >
          Google
        </a>
        {" | "}
        <a href="https://www.facebook.com/about/ads" className="underline">
          Facebook
        </a>
        <br /> <br />
        <p>
        ...
        <br />
        <p>
          <b>Do Not Track.</b> Some Internet browsers can be configured to send
          “Do Not Track” signals to the online services that you visit. We
          currently do not respond to “Do Not Track” or similar signals. You can
